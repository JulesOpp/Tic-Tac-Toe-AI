...
int CheckTwo(char board[], char player, int one, int two, int three)
{
    if(board[one]==player&&board[two]==player&&board[three]==' ')
        return three;
    else if(board[one]==player&&board[three]==player&&board[two]==' ')
        return two;
    else if(board[two]==player&&board[three]==player&&board[one]==' ')
        return one;
    return -1;
}
